...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/hero.js":[function(require,module,exports) {
/******************************************************************
...
$(document).ready(function () {
			...
			function meshBackground() {
						...
						var c, ctx, w, h, spacing, spread, basePoint, rightPoint, botPoint, mouse, mouseMoved, cols, rows, points, tick;
       ...
       */
						...
						(function ($, window, document, undefined) {
									...
									// Plugin constructor
									var Starfield = function Starfield(el, options) {
									...
									Starfield.prototype = {
												...
												init: function init() {
															...
															this.n = parseInt(url.indexOf('n=') != -1 ? url.substring(url.indexOf('n=') + 2, url.substring(url.indexOf('n=') + 2, url.length).indexOf('&') != -1 ? url.indexOf('n=') + 2 + url.substring(url.indexOf('n=') + 2, url.length).indexOf('&') : url.length) : this.settings.quantity);
															...
															var starInit = function starInit() {
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/hero.js"], null)
//# sourceMappingURL=/hero.35044014.map